...
Na internet, muita informação (**dados**) pode estar espalhada de forma não 
muito estruturada para análise ou tomada de decisões.

> O processo de **leitura**, **seleção**, **limpeza**, **armazenagem** e 
**análise** desses dados de forma automatizada é o que queremos dizer por 
"Web Scraping".
...
Obviamente, existem muitas formas de explicar o processo de web scraping, todavia,
ficaremos numa explicação intuitiva e mais direta, que resumimos em três etapas:
...
Primeiro, você deve saber que a página de um *site* é fruto de uma compilação/construção.
...
A linguagem de marcação utiliazada é o [html][HTML] (abreveação para 
*HyperText Markup Language*).

Então, para que você saiba "raspar" algum dado de um site da internet, deve 
...
Tudo bem, você fez a "leitura" do site, mas nem tudo ali você deseja, não?
...
Você deve selecionar esse agrupamento específico do html que você fez a "leitura".

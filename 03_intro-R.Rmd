...
Os outros deverão ser instalados e carregados convenientemente.

Para instalarmos um pacote, no `R`, basta usarmos a função, no console:

```{r, eval=FALSE}
install.packages("nome-do-pacote")
```

Por exemplo, precisaremos instalar o pacote [`polite`](https://dmi3kno.github.io/polite/)
para fazermos a raspagem de dados em mais de uma página.
Portanto, antes de usarmos as funções disponíveis nesse pacote, digitamos no
console:
...
Note as "aspas" no nome do pacote!

> Não se preocupe, pois veremos como se faz isso na prática!
